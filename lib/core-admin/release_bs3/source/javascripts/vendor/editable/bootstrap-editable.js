...
(function ($) {
    ...
    Popup.prototype = {
        ...
        splitOptions: function() {
            ...
            this.formOptions = {};
            var cDef = $.fn[this.containerName].Constructor.DEFAULTS;
...
//             this.$clear = $('<span class="editable-clear-x"></span>');
               this.$clear = $('<span class="editable-clear-x icon-remove-sign"></span>');
...
(function ($) {
    ...
    //buttons
    $.fn.editableform.buttons = '<button type="submit" class="btn btn-blue editable-submit"><i class="icon-ok icon-white"></i></button>'+
                                '<button type="button" class="btn btn-default editable-cancel"><i class="icon-remove"></i></button>';
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        innerCss: $($.fn.popover.Constructor.DEFAULTS.template).find('p').length ? '.popover-content p' : '.popover-content',
...
(function ($) {
    ...
    DateField.defaults = $.extend({}, $.fn.editabletypes.date.defaults, {
        ...
        @property tpl
        **/
        tpl:'<div class="input-group date"><input type="text"/><span class="input-group-addon"><i class="icon-th"></i></span></div>',
        /**
        @property inputclass
        @default 'input-sm'
        **/
