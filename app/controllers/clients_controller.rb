class ClientsController < ApplicationController
  ...
  def client_params
    params.require(:client).permit(:name, :contact, :email1, :email2, :webpage, :phone1, :phone2, :fax, :address1, :address2, :city, :state, :zip, :country, :description, :company_id, :client_type_id, :branch_id, :latitude, :longitude)
  end
end
