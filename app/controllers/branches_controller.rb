class BranchesController < ApplicationController
  ...
  def branch_params
    params.require(:branch).permit(:name, :contact, :main_branch, :email1, :email2, :webpage, :phone1, :phone2, :fax, :address1, :address2, :city, :state, :zip, :country, :description, :company_id)
  end
end
