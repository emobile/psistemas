...
class ClientTypesControllerTest < ActionController::TestCase
  ...
  test "should create client_type" do
    assert_difference('ClientType.count') do
      post :create, client_type: { branch_id: @client_type.branch_id, company_id: @client_type.company_id, description: @client_type.description, name: @client_type.name }
    end
  ...
  test "should update client_type" do
    patch :update, id: @client_type, client_type: { branch_id: @client_type.branch_id, company_id: @client_type.company_id, description: @client_type.description, name: @client_type.name }
    assert_redirected_to client_type_path(assigns(:client_type))
  end
