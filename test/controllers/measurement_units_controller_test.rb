...
class MeasurementUnitsControllerTest < ActionController::TestCase
  ...
  test "should create measurement_unit" do
    assert_difference('MeasurementUnit.count') do
      post :create, measurement_unit: { branch_id: @measurement_unit.branch_id, company_id: @measurement_unit.company_id, description: @measurement_unit.description, name: @measurement_unit.name }
    end
  ...
  test "should update measurement_unit" do
    patch :update, id: @measurement_unit, measurement_unit: { branch_id: @measurement_unit.branch_id, company_id: @measurement_unit.company_id, description: @measurement_unit.description, name: @measurement_unit.name }
    assert_redirected_to measurement_unit_path(assigns(:measurement_unit))
  end
